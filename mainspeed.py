...
def main(yolo):
    ...
    while True:
        ...
        cv2.putText(frame, "Speed meter:" + str(round(highspeed[len(highspeed)-1],2))+"km/h id:"+str(track.track_id), (int(20), int(180)),0, 5e-3 * 200, (0, 0 ,255),2)
        cv2.putText(frame, "Violated Counter: " + str(vio_counter), (int(20), int(150)),0, 5e-3 * 200, (0, 0 ,255),2)
